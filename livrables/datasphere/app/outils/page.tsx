...
export const metadata: Metadata = {
  title: "Outils Data & IA — Comparatifs et fiches détaillées | DataSphère",
  description: "20+ fiches détaillées sur les outils data du marché : Snowflake, Databricks, dbt, Airflow, Spark. Scores, pros/cons et alternatives pour choisir le bon outil.",
};
