...
export const metadata: Metadata = {
  title: "Politique de confidentialité — DataSphère",
  description: "Politique de confidentialité et gestion des données personnelles sur DataSphère.",
};
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 40 }}>
        ...
        <section>
          ...
          <p style={{ fontSize: 15, color: "#475569", lineHeight: 1.8 }}>
            <strong>Prijanth Seevaratnam</strong>, éditeur de datasphere.fr.<br />
            Contact : <a href="mailto:contact@datasphere.fr" style={{ color: "var(--indigo)" }}>contact@datasphere.fr</a>
          </p>
        </section>
        ...
        <section>
          ...
          <div style={{ fontSize: 15, color: "#475569", lineHeight: 1.8 }}>
            <p>DataSphère collecte uniquement les données que tu fournis volontairement :</p>
            <br />
        ...
        <section>
          ...
          <div style={{ fontSize: 15, color: "#475569", lineHeight: 1.8 }}>
            <p>DataSphère utilise les services suivants :</p>
            <br />
            <ul style={{ paddingLeft: 20, display: "flex", flexDirection: "column", gap: 8 }}>
        ...
        <section>
          ...
          <div style={{ fontSize: 15, color: "#475569", lineHeight: 1.8 }}>
            ...
            <br />
            <p>
              Pour exercer ces droits : <a href="mailto:contact@datasphere.fr" style={{ color: "var(--indigo)", fontWeight: 600 }}>contact@datasphere.fr</a><br />
        ...
        <section>
          ...
          <p style={{ fontSize: 15, color: "#475569", lineHeight: 1.8 }}>
            DataSphère n&apos;utilise pas de cookies publicitaires ni de cookies tiers de tracking. Les seuls cookies utilisés sont techniques (session, préférences) et strictement nécessaires au fonctionnement du site.
          </p>
        </section>
