...
export const metadata: Metadata = {
  title: "Quiz data & IA | DataSphere",
  description: "20 quiz de 20 questions pour tester tes connaissances en SQL, Python, Power BI, Azure et plus.",
};
    ...
    <main style={{ minHeight: "60vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ maxWidth: 520, textAlign: "center", padding: "80px 24px" }}>
        ...
        <p style={{ fontSize: 16, color: "#64748B", lineHeight: 1.7, marginBottom: 32 }}>
          20 quiz de 20 questions pour tester tes connaissances — SQL, Python, Power BI, Azure, dbt et plus.
        </p>
        ...
        <div>
          <Link href="/glossaire" style={{ fontSize: 14, color: "#7C3AED", fontWeight: 600 }}>
            En attendant, explore le glossaire →
          </Link>
        </div>
      </div>
    </main>
