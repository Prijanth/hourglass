    ...
    <main style={{ minHeight: "80vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "40px 24px" }}>
      <div style={{ maxWidth: 520, textAlign: "center" }}>
        ...
        <p style={{ fontSize: 16, color: "#64748B", lineHeight: 1.8, marginBottom: 32 }}>
          {dejaAbonne
            ? "Cette adresse email est déjà inscrite à la newsletter DataSphère. Retrouve nos archives ci-dessous."
            : "Bienvenue dans la communauté DataSphère. Tu recevras la prochaine édition lundi matin. D'ici là, explore le site !"}
        </p>
