...
const NAV_GROUPS: NavGroup[] = [
  { label: "Actualités", href: "/actualites" },
  {
    label: "Apprendre",
    items: [
      { href: "/concepts",     label: "Encyclopédie",   desc: "134 concepts ML, Cloud, Gouvernance" },
      { href: "/gouvernance", label: "Gouvernance",    desc: "Catalog, lineage, contracts, RGPD, AI Act" },
  ...
  },
  {
    label: "Jobs",
    items: [
      { href: "/jobs",          label: "Offres d'emploi",   desc: "Plateformes sélectionnées + board natif à venir" },
      { href: "/recruteurs",    label: "Recruteurs",        desc: "Publiez votre offre gratuitement — validation sous 24h" },
