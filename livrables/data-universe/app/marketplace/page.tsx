...
import { MarketplaceFormWrapper } from "./form";
            ...
            <MarketplaceFormWrapper>
              ...
              {[
                ...
                },
                {
                  id: "consent-rights",
                  required: false,
                  label: "Je reconnais avoir pris connaissance de mes droits RGPD : accès, rectification, suppression, portabilité et opposition, exerçables à tout moment via data-universe.fr/confidentialite ou par email à contact@data-universe.fr.",
                },
              ].map(c => (
