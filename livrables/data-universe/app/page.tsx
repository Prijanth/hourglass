...
export default function Home() {
  ...
  return (
    <>
            ...
            <div style={{
              ...
              <div style={{ marginTop: 14, display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <p style={{ fontSize: 12, color: "#94A3B8", lineHeight: 1.4 }}>
                  Contenu vérifié · Communauté data francophone
                </p>
              </div>
        ...
        <div className="marquee-track">
          {[...Array(2)].map((_, i) => (
            <div key={i} style={{ display: "flex" }}>
              {[
                { label: "Machine Learning",      href: "/glossaire?q=Machine+Learning" },
                { label: "Data Engineering",      href: "/metiers/data-engineer" },
                { label: "LLM et IA Générative",  href: "/ia" },
                { label: "Cloud AWS",             href: "/certifications?q=AWS" },
                { label: "Cloud Azure",           href: "/certifications?q=Azure" },
                { label: "Cloud GCP",             href: "/certifications?q=Google" },
                { label: "Data Gouvernance",      href: "/glossaire?q=gouvernance" },
                { label: "Databricks",            href: "/outils/databricks" },
                { label: "Apache Spark",          href: "/glossaire?q=Spark" },
                { label: "Analytics Engineering", href: "/metiers/analytics-engineer" },
                { label: "Snowflake",             href: "/outils/snowflake" },
                { label: "MLOps",                 href: "/glossaire?q=MLOps" },
                { label: "NLP",                   href: "/glossaire?q=NLP" },
                { label: "Feature Engineering",   href: "/glossaire?q=Feature+Engineering" },
              ].map(({ label, href }) => (
                <Link key={label} href={href} style={{ display: "flex", alignItems: "center", gap: 18, padding: "0 24px", borderRight: "1px solid #F1F5F9", textDecoration: "none" }}>
                  <span style={{ width: 4, height: 4, borderRadius: "50%", background: "#A78BFA", display: "inline-block", flexShrink: 0 }} />
                  <span style={{ fontSize: 12, color: "#94A3B8", fontFamily: "var(--font-mono)", whiteSpace: "nowrap" }}>{label}</span>
                </Link>
              ))}
            </div>
          ))}
        ...
        <div style={{ maxWidth: 1240, margin: "0 auto" }} className="cta-grid">
          ...
          <div style={{
            ...
            <p style={{ fontSize: 14.5, color: "rgba(255,255,255,0.78)", lineHeight: 1.7 }}>
              Publie ton offre gratuitement et touche notre communauté data francophone — Data Engineers, Data Scientists, Analytics Engineers.
            </p>
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
      ...
      <section style={{ padding: "64px 24px", background: "#F8FAFC", borderTop: "1px solid #E2E8F0", borderBottom: "1px solid #E2E8F0" }}>
        <div style={{ maxWidth: 1240, margin: "0 auto" }}>
          <div style={{ marginBottom: 32 }}>
            <span className="section-label">Praticien confirmé</span>
            <h2 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(1.5rem, 2.5vw, 2rem)", fontWeight: 800, color: "#0F172A" }}>
              Tu travailles déjà en data ? Va à l&apos;essentiel.
            </h2>
          </div>
            ...
            {[
              {
                ...
                emoji: "🤖",
                title: "Agents IA",
                desc: "47 agents documentés avec architecture, stack et cas d'usage en production",
              ...
              },
              {
                ...
                desc: "104 projets avec stack technique, solution et résultats mesurés — filtrables par domaine",
                color: "#C2410C", bg: "#FFF7ED", border: "#FED7AA",
              },
              {
                href: "/certifications/roadmap",
                emoji: "🏆",
              ...
              <Link key={href} href={href} className="card" style={{ padding: "22px 20px", display: "flex", flexDirection: "column", gap: 12, borderColor: border }}>
                ...
                <div>
                  <h3 style={{ fontFamily: "var(--font-display)", fontSize: 15, fontWeight: 700, color, marginBottom: 6 }}>{title}</h3>
                  <p style={{ fontSize: 12.5, color: "#64748B", lineHeight: 1.6 }}>{desc}</p>
                </div>
              </Link>
            ))}
      ...
      {/* ── SKILLS + RECENT ───────────────────────────────── */}
      <section style={{ padding: "72px 24px", background: "#FFFFFF" }}>
        <div style={{ maxWidth: 1240, margin: "0 auto" }} className="skills-recent-grid">
      ...
      <section style={{ padding: "80px 24px", background: "#FFFFFF" }}>
        <div style={{ maxWidth: 620, margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ fontSize: 16, color: "#64748B", marginBottom: 28, lineHeight: 1.7 }}>
            Actualités filtrées, concepts expliqués, nouvelles certifications. Gratuit, en français.
          </p>
