...
const FAQ = [
  ...
  },
  {
    ...
    r: "De 9 à 18 mois selon ton profil de départ. Quelqu'un qui part d'un profil analytique (finance, marketing, RH) peut viser Data Analyst en 9-12 mois. Une reconversion complète depuis un profil non technique prend plutôt 12-18 mois. La clé : combiner formation + certif + projet réel.",
  },
  {
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", position: "relative" }}>
          ...
          <div style={{ display: "flex", gap: 32, marginTop: 48, paddingTop: 32, borderTop: "1px solid #DDD6FE", flexWrap: "wrap" }}>
            {[
              ...
              { n: "9-18", l: "mois pour être employable*" },
          ...
          <p style={{ fontSize: 12, color: "#94A3B8", marginTop: 12 }}>
            * 9-12 mois depuis un profil analytique (finance, marketing, RH) vers Data Analyst. 12-18 mois pour une reconversion complète depuis un profil non-technique. Les examens de certification sont payants (50-300€).
          </p>
        </div>
      </section>
