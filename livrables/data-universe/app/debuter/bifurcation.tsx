...
type Choix = "zero" | "profil" | "allie" | null;
  ...
  return (
    <div>
      ...
      >
        ...
        {/* Card 3 — Je collabore avec la data */}
        <button
          onClick={() => handleChoix("allie")}
          style={{
            flex: "1 1 280px",
            minWidth: 280,
            maxWidth: 400,
            ...
            border: choix === "allie"
              ? "2px solid #059669"
              : "2px solid #A7F3D0",
            background: choix === "allie" ? "#D1FAE5" : "#F0FDF4",
            cursor: "pointer",
            position: "relative",
            transition: "border-color 0.2s, background 0.2s, box-shadow 0.2s, transform 0.15s",
            boxShadow: choix === "allie"
              ? "0 4px 16px rgba(5,150,105,0.18)"
              : "0 1px 4px rgba(0,0,0,0.04)",
            transform: choix === "allie" ? "translateY(-2px)" : "translateY(0)",
          }}
          aria-pressed={choix === "allie"}
        >
          {choix === "allie" && (
            <span
              style={{
          ...
          >
            Je collabore avec des équipes data sans en faire mon métier principal
          </div>
          <div
            style={{
              fontSize: 12,
          ...
          >
            <span style={{ fontWeight: 700 }}>Vient de :</span> Marketing, Communication, Management, Finance, RH, Product
          </div>
          <div
            style={{
              fontSize: 13.5,
              fontWeight: 700,
              color: choix === "allie" ? "#059669" : "#94A3B8",
              transition: "color 0.2s",
            }}
          >
            {choix === "allie" ? "Ces ressources sont pour moi ✓" : "Ces ressources sont pour moi →"}
          </div>
        </button>
      ...
      {/* ── Recommandations "Je travaille avec la data" ── */}
      {choix === "allie" && (
        <div
          style={{
            marginTop: 32,
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
            <span style={{ fontFamily: "var(--font-display)", fontSize: 16, fontWeight: 800, color: "#064E3B" }}>
              Les ressources faites pour toi
            </span>
          </div>
          <p style={{ fontSize: 13.5, color: "#065F46", lineHeight: 1.65, marginBottom: 24, maxWidth: 560 }}>
            Tu n&apos;as pas besoin de coder pour comprendre la data. Ces ressources t&apos;aident à collaborer efficacement avec des équipes data et à prendre de meilleures décisions fondées sur les données.
          </p>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: 14, marginBottom: 24 }}>
            {[
              { href: "/glossaire", label: "Glossaire data", desc: "246 termes expliqués en français — comprenez ce que dit votre équipe data", tag: "Incontournable" },
              { href: "/cas-usage", label: "Cas d'usage métier", desc: "Marketing, RH, Finance — comment la data résout des problèmes concrets", tag: "Concret" },
              { href: "/metiers", label: "Qui fait quoi ?", desc: "Comprendre les rôles data pour mieux collaborer avec eux", tag: "Pratique" },
              { href: "/concepts", label: "Concepts clés", desc: "A/B Testing, segmentation, NLP — les concepts utiles aux équipes métier", tag: "Accessible" },
            ].map(({ href, label, desc, tag }) => (
              <a key={href} href={href} style={{ display: "block", background: "#fff", border: "1px solid #A7F3D0", borderRadius: 12, padding: "16px 18px", textDecoration: "none", transition: "border-color 0.15s" }}>
                <div style={{ fontSize: 10, fontWeight: 700, textTransform: "uppercase" as const, letterSpacing: "0.1em", color: "#059669", marginBottom: 6 }}>{tag}</div>
          ...
          <div style={{ padding: "14px 18px", background: "#ECFDF5", borderRadius: 10, border: "1px solid #A7F3D0" }}>
            <p style={{ fontSize: 13, color: "#065F46", lineHeight: 1.6, margin: 0 }}>
              <span style={{ fontWeight: 700 }}>Tip :</span> commence par le <a href="/glossaire" style={{ color: "#059669", fontWeight: 700 }}>glossaire</a> — note les 5 termes que ton équipe data utilise le plus souvent et cherche-les ici. En une heure, tu auras le vocabulaire essentiel.
            </p>
          </div>
        </div>
      )}
