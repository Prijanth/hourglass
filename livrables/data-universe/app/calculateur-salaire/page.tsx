            ...
            <div style={{ position: "sticky", top: 80, display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div style={{ textAlign: "center" }}>
                <p style={{ fontSize: 11, color: "var(--faint)", lineHeight: 1.6 }}>
                  Estimation indicative basée sur 5 sources croisées — offres LinkedIn, Glassdoor, enquêtes sectorielles. CDI France uniquement.
                </p>
                <a href="/calculateur-salaire/methodologie" style={{ fontSize: 11, color: "#7C3AED", fontWeight: 600, textDecoration: "underline", textUnderlineOffset: 2, marginTop: 4, display: "inline-block" }}>
