...
export const metadata: Metadata = {
  title: "Comparatifs outils data & IA 2026 | Data Universe",
  description: "Comparatifs détaillés des principales plateformes data et IA du marché : Databricks vs Snowflake, dbt vs Dataform, et bien d'autres.",
};
    ...
    <>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "48px 24px" }}>
        ...
        <div style={{
          ...
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#7C3AED" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, marginTop: 1 }}>
            <circle cx="12" cy="12" r="10"/><path d="M12 16v-4M12 8h.01"/>
          </svg>
          <p style={{ fontSize: 12.5, color: "#475569", lineHeight: 1.65, margin: 0 }}>
            <span style={{ fontWeight: 700, color: "#0F172A" }}>Méthodologie :</span> chaque score (/100) est une évaluation éditoriale calculée sur plusieurs critères pondérés (performance, facilité d&apos;utilisation, coût, écosystème, support). Les critères et leurs scores détaillés sont visibles dans chaque comparatif. Ces évaluations reflètent des cas d&apos;usage courants en entreprise française — elles ne se substituent pas à une évaluation sur votre contexte spécifique.
          </p>
        </div>
