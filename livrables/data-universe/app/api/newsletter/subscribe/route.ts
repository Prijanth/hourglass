...
export async function POST(req: NextRequest) {
  ...
  const prenomDisplay = prenom ? ` ${htmlEscape(prenom.trim().slice(0, 50))}` : "";
    ...
    html: `
      <div style="font-family: system-ui, sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 24px; background: #ffffff;">
        ...
        <p style="font-size: 16px; color: #475569; line-height: 1.7; margin-bottom: 28px;">
          Tu es à un clic de rejoindre la communauté <strong>Data Universe</strong> et de recevoir
        ...
        <p style="font-size: 13px; color: #94A3B8; margin-top: 28px; line-height: 1.6;">
          Ce lien est valable 24 heures. Si tu n'as pas demandé cette inscription, ignore simplement cet email — aucune action n'est requise.
        </p>
