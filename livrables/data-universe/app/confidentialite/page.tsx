        ...
        <section>
          ...
          <div style={{ fontSize: 15, color: "#475569", lineHeight: 1.8 }}>
            ...
            <ul style={{ paddingLeft: 20, display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              <li><strong>Portabilité</strong> : recevoir tes données dans un format structuré et lisible (Art. 20 RGPD)</li>
              <li><strong>Limitation</strong> : demander la suspension temporaire d&apos;un traitement (Art. 18 RGPD)</li>
