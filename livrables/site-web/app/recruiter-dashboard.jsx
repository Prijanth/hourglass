/* Tableau de bord recruteur — Hourglass (FR) */

const CANDIDATES_IN_QUEUE = [
  { name: "Akira Tan", role: "Product Designer senior", loc: "Berlin", yrs: 6, status: "reviewing" },
  { name: "Sofia Bianchi", role: "Product Designer senior", loc: "Milan", yrs: 8, status: "queued" },
  { name: "Devon Park", role: "Product Designer senior", loc: "Toronto", yrs: 5, status: "queued" },
  { name: "Mira Achebe", role: "Product Designer senior", loc: "Londres", yrs: 9, status: "done", outcome: "accept" },
  { name: "Yusuf El-Amin", role: "Product Designer senior", loc: "Le Caire", yrs: 4, status: "done", outcome: "pass" },
];
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              ...
              <div style={{ display: "flex", gap: 10 }}>
                ...
                <button className="hg-btn hg-btn-primary" onClick={() => navigate('session')}><Icon name="hourglass" size={14}/> Ouvrir le studio</button>
              </div>
            </div>
            <div style={{ display: "flex", marginTop: 20, gap: 14, alignItems: "center" }}>
              {CANDIDATES_IN_QUEUE.slice(0, 3).map((c) => (
            ...
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              <thead>
                <tr style={{ fontSize: 11, color: "var(--ink-faint)", textTransform: "uppercase", letterSpacing: "0.08em" }}>
                  <th style={tHead}>Date</th>
                  <th style={tHead}>Poste</th>
                  <th style={tHead}>Lus</th>
                  <th style={tHead}>Acceptés</th>
                  <th style={tHead}>Entretiens</th>
                  <th style={tHead}>Entonnoir</th>
                  <th style={tHead}></th>
                </tr>
              </thead>
              <tbody>
                  ...
                  <tr key={i} style={{ borderTop: "1px solid var(--line)" }}>
                    ...
                    <td style={tCell}>
                      <div style={{ display: "flex", gap: 3, alignItems: "center" }}>
                        <div style={{ width: 50, height: 6, borderRadius: 999, background: "var(--ink)", flexShrink: 0 }}/>
                        <div style={{ width: 50 * (s.accepted/s.reviewed), height: 6, borderRadius: 999, background: "var(--teal)", flexShrink: 0 }}/>
                        <div style={{ width: 50 * (s.interviews/s.reviewed), height: 6, borderRadius: 999, background: "var(--violet)", flexShrink: 0 }}/>
                      </div>
                    </td>
              ...
              {Array.from({ length: 28 }).map((_, i) => {
                ...
                return (
                  <div key={i} style={{
                    ...
                    background: active ? "var(--ink)" : session ? "var(--teal-tint)" : "transparent",
