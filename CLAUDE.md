...
Ce workspace est le Jarvis personnel de Prijanth. Il a été créé avec le Jarvis Starter Kit pour servir d'assistant IA personnel au quotidien.
...
Je m'appelle Prijanth et je vis à Montry (Seine-et-Marne, 77). Je suis Consultant Senior en Data chez TNP Consultants, actuellement en mission à La Banque Postale comme Product Owner sur les reportings réglementaires ESG (taxonomie et Pilier 3). En parallèle, je travaille sur des appels d'offre pour mon cabinet et la reprise d'un périmètre Dataiku/SAS Viya.

Mes objectifs prioritaires actuels sont d'obtenir la certification AWS ML Engineer, monter en compétences sur Dataiku et SAS Viya, remporter des appels d'offre, et lancer mes premiers projets web/applications.

À long terme, je veux lancer ma propre entreprise, créer des produits numériques qui me génèrent un revenu confortable, et devenir une référence reconnue dans le domaine de la data et de l'IA.

Le domaine où j'ai besoin du plus d'aide en ce moment : création de contenu (sites web, applications, TikTok, etc.).
